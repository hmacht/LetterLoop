...
<ul class="definition-list">
	...
	<li>You must fill in every word before submitting.</li>
</ul>
<h3>Example</h3>
<p>If we had these letters:</p>
<img src={ex_letter_box} alt="Welcome" style="width: 350px; max-width: 100%; height: auto;" />
<p>
...
<p>
	Notice how these words share an <b><span style="color: red;">M</span></b> and a
	<b><span style="color: red;">C</span></b>.
</p>
<p>One correct solution:</p>
<img src={ex_solution} alt="Welcome" style="width: 150px; max-width: 100%; height: auto;" />
