...
const css = {
  code: ".shirt-ad.svelte-1tu46dl{display:none;margin:0 auto;padding-top:1rem}@media(min-width: 500px){.shirt-ad.large-screen.svelte-1tu46dl{display:block;max-width:550px;width:90%\n      }}@media(max-width: 500px){.shirt-ad.mobile-screen.svelte-1tu46dl{display:block;width:90%}}.banner-ad.svelte-1tu46dl{margin:0 auto;margin-bottom:15px}",
  map: null
};
