import{n as ye,j as cl,r as An,i as hl,z as Ei,a as Dn,c as hn,h as ul,A as Ii,e as bi,u as Ti,g as Si,f as Ni,B as dl,d as gt,C as on,o as fl,D as Ri}from"../chunks/scheduler.CwIiqDyD.js";import{y as _l,z as pl,A as ml,B as gl,n as Te,l as Se,S as Pn,i as Mn,e as b,c as T,a as q,d as y,o as P,g as D,q as yl,m as vl,t as me,s as O,b as ge,f as L,p as Lt,h as I,j as De,C as ki,u as ft,v as _t,w as pt,D as he,E as Cl,F as wl,x as mt,G as an,H as ee,I as El,J as qr,K as Ft}from"../chunks/index.CIKh10TN.js";import{d as Il,w as cs,r as bl}from"../chunks/index.NVK073Jc.js";function Tl(n,e,t,s){if(!e)return ye;const i=n.getBoundingClientRect();if(e.left===i.left&&e.right===i.right&&e.top===i.top&&e.bottom===i.bottom)return ye;const{delay:r=0,duration:o=300,easing:a=cl,start:l=_l()+r,end:c=l+o,tick:h=ye,css:u}=t(n,{from:e,to:i},s);let d=!0,f=!1,_;function v(){u&&(_=ml(n,0,1,o,r,a,u)),r||(f=!0)}function g(){u&&gl(n,_),d=!1}return pl(w=>{if(!f&&w>=l&&(f=!0),f&&w>=c&&(h(1,0),g()),!d)return!1;if(f){const F=w-l,R=0+1*a(F/o);h(R,1-R)}return!0}),v(),h(0,1),g}function Sl(n){const e=getComputedStyle(n);if(e.position!=="absolute"&&e.position!=="fixed"){const{width:t,height:s}=e,i=n.getBoundingClientRect();n.style.position="absolute",n.style.width=t,n.style.height=s,Gr(n,i)}}function Gr(n,e){const t=n.getBoundingClientRect();if(e.left!==t.left||e.top!==t.top){const s=getComputedStyle(n),i=s.transform==="none"?"":s.transform;n.style.transform=`${i} translate(${e.left-t.left}px, ${e.top-t.top}px)`}}function $e(n){return(n==null?void 0:n.length)!==void 0?n:Array.from(n)}function Nl(n,e){n.d(1),e.delete(n.key)}function Rl(n,e){Se(n,1,1,()=>{e.delete(n.key)})}function kl(n,e){n.f(),Rl(n,e)}function Kr(n,e,t,s,i,r,o,a,l,c,h,u){let d=n.length,f=r.length,_=d;const v={};for(;_--;)v[n[_].key]=_;const g=[],w=new Map,F=new Map,R=[];for(_=f;_--;){const N=u(i,r,_),C=t(N);let E=o.get(C);E?s&&R.push(()=>E.p(N,e)):(E=c(C,N),E.c()),w.set(C,g[_]=E),C in v&&F.set(C,Math.abs(_-v[C]))}const S=new Set,V=new Set;function B(N){Te(N,1),N.m(a,h),o.set(N.key,N),h=N.first,f--}for(;d&&f;){const N=g[f-1],C=n[d-1],E=N.key,x=C.key;N===C?(h=N.first,d--,f--):w.has(x)?!o.has(E)||S.has(E)?B(N):V.has(x)?d--:F.get(E)>F.get(x)?(V.add(E),B(N)):(S.add(x),d--):(l(C,o),d--)}for(;d--;){const N=n[d];w.has(N.key)||l(N,o)}for(;f;)B(g[f-1]);return An(R),g}const Al=!0,up=Object.freeze(Object.defineProperty({__proto__:null,prerender:Al},Symbol.toStringTag,{value:"Module"}));function Yr(n){const e=n-1;return e*e*e+1}function Dl(n,{from:e,to:t},s={}){const i=getComputedStyle(n),r=i.transform==="none"?"":i.transform,[o,a]=i.transformOrigin.split(" ").map(parseFloat),l=e.left+e.width*o/t.width-(t.left+o),c=e.top+e.height*a/t.height-(t.top+a),{delay:h=0,duration:u=f=>Math.sqrt(f)*120,easing:d=Yr}=s;return{delay:h,duration:hl(u)?u(Math.sqrt(l*l+c*c)):u,easing:d,css:(f,_)=>{const v=_*l,g=_*c,w=f+_*e.width/t.width,F=f+_*e.height/t.height;return`transform: ${r} translate(${v}px, ${g}px) scale(${w}, ${F});`}}}function Ai(n,{delay:e=0,duration:t=400,easing:s=Yr,x:i=0,y:r=0,opacity:o=0}={}){const a=getComputedStyle(n),l=+a.opacity,c=a.transform==="none"?"":a.transform,h=l*(1-o),[u,d]=Ei(i),[f,_]=Ei(r);return{delay:e,duration:t,easing:s,css:(v,g)=>`
			transform: ${c} translate(${(1-v)*u}${d}, ${(1-v)*f}${_});
			opacity: ${l-h*g}`}}function Pl(n){const e=cs([]);function t(r,o="default",a){e.update(l=>[...l,{id:Ml(),type:o,message:r,timeout:a}])}const s=Il(e,(r,o)=>{if(o(r),r.length>0){const a=setTimeout(()=>{e.update(l=>(l.shift(),l))},r[0].timeout);return()=>{clearTimeout(a)}}}),{subscribe:i}=s;return{subscribe:i,send:t,default:(r,o)=>t(r,"default",o),danger:(r,o)=>t(r,"danger",o),warning:(r,o)=>t(r,"warning",o),info:(r,o)=>t(r,"info",o),success:(r,o)=>t(r,"success",o)}}function Ml(){return"_"+Math.random().toString(36).substr(2,9)}const un=Pl();function Di(n,e,t){const s=n.slice();return s[1]=e[t],s}function Pi(n){let e,t;return{c(){e=b("i"),this.h()},l(s){e=T(s,"I",{class:!0}),q(e).forEach(y),this.h()},h(){P(e,"class",t=Ii(n[1].icon)+" svelte-15ecllt")},m(s,i){D(s,e,i)},p(s,i){i&1&&t!==(t=Ii(s[1].icon)+" svelte-15ecllt")&&P(e,"class",t)},d(s){s&&y(e)}}}function Mi(n,e){let t,s,i=e[1].message+"",r,o,a,l,c,h=ye,u,d=e[1].icon&&Pi(e);return{key:n,first:null,c(){t=b("div"),s=b("div"),r=me(i),o=O(),d&&d.c(),a=O(),this.h()},l(f){t=T(f,"DIV",{class:!0,style:!0});var _=q(t);s=T(_,"DIV",{class:!0});var v=q(s);r=ge(v,i),v.forEach(y),o=L(_),d&&d.l(_),a=L(_),_.forEach(y),this.h()},h(){P(s,"class","content svelte-15ecllt"),P(t,"class","toast svelte-15ecllt"),Lt(t,"background","#EBEBEB"),this.first=t},m(f,_){D(f,t,_),I(t,s),I(s,r),I(t,o),d&&d.m(t,null),I(t,a),u=!0},p(f,_){e=f,(!u||_&1)&&i!==(i=e[1].message+"")&&De(r,i),e[1].icon?d?d.p(e,_):(d=Pi(e),d.c(),d.m(t,a)):d&&(d.d(1),d=null)},r(){c=t.getBoundingClientRect()},f(){Sl(t),h(),Gr(t,c)},a(){h(),h=Tl(t,c,Dl,{})},i(f){u||(f&&ul(()=>{u&&(l||(l=ki(t,Ai,{y:30},!0)),l.run(1))}),u=!0)},o(f){f&&(l||(l=ki(t,Ai,{y:30},!1)),l.run(0)),u=!1},d(f){f&&y(t),d&&d.d(),f&&l&&l.end()}}}function xl(n){let e,t=[],s=new Map,i,r=$e(n[0]);const o=a=>a[1].id;for(let a=0;a<r.length;a+=1){let l=Di(n,r,a),c=o(l);s.set(c,t[a]=Mi(c,l))}return{c(){e=b("div");for(let a=0;a<t.length;a+=1)t[a].c();this.h()},l(a){e=T(a,"DIV",{class:!0});var l=q(e);for(let c=0;c<t.length;c+=1)t[c].l(l);l.forEach(y),this.h()},h(){P(e,"class","notifications svelte-15ecllt")},m(a,l){D(a,e,l);for(let c=0;c<t.length;c+=1)t[c]&&t[c].m(e,null);i=!0},p(a,[l]){if(l&1){r=$e(a[0]),yl();for(let c=0;c<t.length;c+=1)t[c].r();t=Kr(t,l,o,1,a,r,s,e,kl,Mi,null,Di);for(let c=0;c<t.length;c+=1)t[c].a();vl()}},i(a){if(!i){for(let l=0;l<r.length;l+=1)Te(t[l]);i=!0}},o(a){for(let l=0;l<t.length;l+=1)Se(t[l]);i=!1},d(a){a&&y(e);for(let l=0;l<t.length;l+=1)t[l].d()}}}function Ol(n,e,t){let s;return hn(n,un,i=>t(0,s=i)),[s]}class Qr extends Pn{constructor(e){super(),Mn(this,e,Ol,xl,Dn,{})}}const Ll=n=>({}),xi=n=>({});function Oi(n){let e,t,s;return{c(){e=b("i"),this.h()},l(i){e=T(i,"I",{class:!0}),q(e).forEach(y),this.h()},h(){P(e,"class","fa-solid fa-xmark svelte-kvu5ns")},m(i,r){D(i,e,r),t||(s=he(e,"click",n[6]),t=!0)},p:ye,d(i){i&&y(e),t=!1,s()}}}function Fl(n){let e,t,s,i,r,o,a,l,c,h,u,d,f,_;s=new Qr({});const v=n[4].header,g=bi(v,n,n[3],xi);let w=!n[1]&&Oi(n);const F=n[4].default,R=bi(F,n,n[3],null);return{c(){e=b("dialog"),t=b("div"),ft(s.$$.fragment),i=O(),r=b("div"),g&&g.c(),o=O(),a=b("div"),l=O(),w&&w.c(),c=O(),h=b("hr"),u=O(),R&&R.c(),this.h()},l(S){e=T(S,"DIALOG",{class:!0});var V=q(e);t=T(V,"DIV",{class:!0});var B=q(t);_t(s.$$.fragment,B),i=L(B),r=T(B,"DIV",{class:!0});var N=q(r);g&&g.l(N),o=L(N),a=T(N,"DIV",{class:!0}),q(a).forEach(y),l=L(N),w&&w.l(N),N.forEach(y),c=L(B),h=T(B,"HR",{}),u=L(B),R&&R.l(B),B.forEach(y),V.forEach(y),this.h()},h(){P(a,"class","spacer svelte-kvu5ns"),P(r,"class","flex-container svelte-kvu5ns"),P(t,"class","svelte-kvu5ns"),P(e,"class","svelte-kvu5ns")},m(S,V){D(S,e,V),I(e,t),pt(s,t,null),I(t,i),I(t,r),g&&g.m(r,null),I(r,o),I(r,a),I(r,l),w&&w.m(r,null),I(t,c),I(t,h),I(t,u),R&&R.m(t,null),n[7](e),d=!0,f||(_=[he(t,"click",Cl(n[5])),he(e,"close",n[8]),he(e,"click",wl(n[9]))],f=!0)},p(S,[V]){g&&g.p&&(!d||V&8)&&Ti(g,v,S,S[3],d?Ni(v,S[3],V,Ll):Si(S[3]),xi),S[1]?w&&(w.d(1),w=null):w?w.p(S,V):(w=Oi(S),w.c(),w.m(r,null)),R&&R.p&&(!d||V&8)&&Ti(R,F,S,S[3],d?Ni(F,S[3],V,null):Si(S[3]),null)},i(S){d||(Te(s.$$.fragment,S),Te(g,S),Te(R,S),d=!0)},o(S){Se(s.$$.fragment,S),Se(g,S),Se(R,S),d=!1},d(S){S&&y(e),mt(s),g&&g.d(S),w&&w.d(),R&&R.d(S),n[7](null),f=!1,An(_)}}}function Bl(n,e,t){let{$$slots:s={},$$scope:i}=e,{showModal:r}=e,{hide_close:o=!1}=e,a;function l(f){dl.call(this,n,f)}const c=()=>a.close();function h(f){gt[f?"unshift":"push"](()=>{a=f,t(2,a)})}const u=()=>t(0,r=!1),d=()=>!o&&a.close();return n.$$set=f=>{"showModal"in f&&t(0,r=f.showModal),"hide_close"in f&&t(1,o=f.hide_close),"$$scope"in f&&t(3,i=f.$$scope)},n.$$.update=()=>{n.$$.dirty&5&&a&&(r?a.showModal():a.close()),n.$$.dirty&5&&a&&r===!1&&a.open&&a.close()},[r,o,a,i,s,l,c,h,u,d]}class Kn extends Pn{constructor(e){super(),Mn(this,e,Bl,Fl,Dn,{showModal:0,hide_close:1})}}const $l=""+new URL("../assets/ex-solution.DMtatkDj.png",import.meta.url).href,Hl=""+new URL("../assets/ex-letter-box.mgBNjwYG.png",import.meta.url).href;var Li={};/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vl(n){return eo(void 0,n)}function eo(n,e){if(!(e instanceof Object))return e;switch(e.constructor){case Date:const t=e;return new Date(t.getTime());case Object:n===void 0&&(n={});break;case Array:n=[];break;default:return e}for(const t in e)!e.hasOwnProperty(t)||!jl(t)||(n[t]=eo(n[t],e[t]));return n}function jl(n){return n!=="__proto__"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const et=new Ps("@firebase/app"),xc="@firebase/app-compat",Oc="@firebase/analytics-compat",Lc="@firebase/analytics",Fc="@firebase/app-check-compat",Bc="@firebase/app-check",$c="@firebase/auth",Hc="@firebase/auth-compat",Uc="@firebase/database",Wc="@firebase/database-compat",Vc="@firebase/functions",jc="@firebase/functions-compat",zc="@firebase/installations",qc="@firebase/installations-compat",Gc="@firebase/messaging",Kc="@firebase/messaging-compat",Yc="@firebase/performance",Qc="@firebase/performance-compat",Xc="@firebase/remote-config",Jc="@firebase/remote-config-compat",Zc="@firebase/storage",eh="@firebase/storage-compat",th="@firebase/firestore",nh="@firebase/firestore-compat",sh="firebase",ih="10.8.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _s="[DEFAULT]",rh={[fs]:"fire-core",[xc]:"fire-core-compat",[Lc]:"fire-analytics",[Oc]:"fire-analytics-compat",[Bc]:"fire-app-check",[Fc]:"fire-app-check-compat",[$c]:"fire-auth",[Hc]:"fire-auth-compat",[Uc]:"fire-rtdb",[Wc]:"fire-rtdb-compat",[Vc]:"fire-fn",[jc]:"fire-fn-compat",[zc]:"fire-iid",[qc]:"fire-iid-compat",[Gc]:"fire-fcm",[Kc]:"fire-fcm-compat",[Yc]:"fire-perf",[Qc]:"fire-perf-compat",[Xc]:"fire-rc",[Jc]:"fire-rc-compat",[Zc]:"fire-gcs",[eh]:"fire-gcs-compat",[th]:"fire-fst",[nh]:"fire-fst-compat","fire-js":"fire-js",[sh]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pn=new Map,ps=new Map;function oh(n,e){try{n.container.addComponent(e)}catch(t){et.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function Ve(n){const e=n.name;if(ps.has(e))return et.debug(`There were multiple attempts to register component ${e}.`),!1;ps.set(e,n);for(const t of pn.values())oh(t,n);return!0}function Jt(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ch=ih;function uo(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const s=Object.assign({name:_s,automaticDataCollectionEnabled:!1},e),i=s.name;if(typeof i!="string"||!i)throw Ue.create("bad-app-name",{appName:String(i)});if(t||(t=no()),!t)throw Ue.create("no-options");const r=pn.get(i);if(r){if(_n(t,r.options)&&_n(s,r.config))return r;throw Ue.create("duplicate-app",{appName:i})}const o=new gc(i);for(const l of ps.values())o.addComponent(l);const a=new lh(t,s,o);return pn.set(i,a),a}function fo(n=_s){const e=pn.get(n);if(!e&&n===_s&&no())return uo();if(!e)throw Ue.create("no-app",{appName:n});return e}function Ne(n,e,t){var s;let i=(s=rh[n])!==null&&s!==void 0?s:n;t&&(i+=`-${t}`);const r=i.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const a=[`Unable to register library "${i}" with version "${e}":`];r&&a.push(`library name "${i}" contains illegal characters (whitespace or "/")`),r&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),et.warn(a.join(" "));return}Ve(new Me(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hh="firebase-heartbeat-database",uh=1,jt="firebase-heartbeat-store";let Jn=null;function _o(){return Jn||(Jn=ho(hh,uh,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(jt)}catch(t){console.warn(t)}}}}).catch(n=>{throw Ue.create("idb-open",{originalErrorMessage:n.message})})),Jn}async function dh(n){try{const t=(await _o()).transaction(jt),s=await t.objectStore(jt).get(po(n));return await t.done,s}catch(e){if(e instanceof at)et.warn(e.message);else{const t=Ue.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});et.warn(t.message)}}}async function ji(n,e){try{const s=(await _o()).transaction(jt,"readwrite");await s.objectStore(jt).put(e,po(n)),await s.done}catch(t){if(t instanceof at)et.warn(t.message);else{const s=Ue.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});et.warn(s.message)}}}function po(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fh=1024,_h=30*24*60*60*1e3;class ph{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new gh(t),this._heartbeatsCachePromise=this._storage.read().then(s=>(this._heartbeatsCache=s,s))}async triggerHeartbeat(){var e,t;const i=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),r=zi();if(!(((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null))&&!(this._heartbeatsCache.lastSentHeartbeatDate===r||this._heartbeatsCache.heartbeats.some(o=>o.date===r)))return this._heartbeatsCache.heartbeats.push({date:r,agent:i}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter(o=>{const a=new Date(o.date).valueOf();return Date.now()-a<=_h}),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){var e;if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";const t=zi(),{heartbeatsToSend:s,unsentEntries:i}=mh(this._heartbeatsCache.heartbeats),r=dn(JSON.stringify({version:2,heartbeats:s}));return this._heartbeatsCache.lastSentHeartbeatDate=t,i.length>0?(this._heartbeatsCache.heartbeats=i,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}}function zi(){return new Date().toISOString().substring(0,10)}function mh(n,e=fh){const t=[];let s=n.slice();for(const i of n){const r=t.find(o=>o.agent===i.agent);if(r){if(r.dates.push(i.date),qi(t)>e){r.dates.pop();break}}else if(t.push({agent:i.agent,dates:[i.date]}),qi(t)>e){t.pop();break}s=s.slice(1)}return{heartbeatsToSend:t,unsentEntries:s}}class gh{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return ro()?oo().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await dh(this.app);return t!=null&&t.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return ji(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){var t;if(await this._canUseIndexedDBPromise){const i=await this.read();return ji(this.app,{lastSentHeartbeatDate:(t=e.lastSentHeartbeatDate)!==null&&t!==void 0?t:i.lastSentHeartbeatDate,heartbeats:[...i.heartbeats,...e.heartbeats]})}else return}}function qi(n){return dn(JSON.stringify({version:2,heartbeats:n})).length}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yh(n){Ve(new Me("platform-logger",e=>new Pc(e),"PRIVATE")),Ve(new Me("heartbeat",e=>new ph(e),"PRIVATE")),Ne(fs,Vi,n),Ne(fs,Vi,"esm2017"),Ne("fire-js","")}yh("");var vh="firebase",Ch="10.8.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr=32,or=768;class Y{constructor(e,t){if(t===void 0){this.pieces_=e.split("/");let s=0;for(let i=0;i<this.pieces_.length;i++)this.pieces_[i].length>0&&(this.pieces_[s]=this.pieces_[i],s++);this.pieces_.length=s,this.pieceNum_=0}else this.pieces_=e,this.pieceNum_=t}toString(){let e="";for(let t=this.pieceNum_;t<this.pieces_.length;t++)this.pieces_[t]!==""&&(e+="/"+this.pieces_[t]);return e||"/"}}function K(){return new Y("")}function $(n){return n.pieceNum_>=n.pieces_.length?null:n.pieces_[n.pieceNum_]}function je(n){return n.pieces_.length-n.pieceNum_}function J(n){let e=n.pieceNum_;return e<n.pieces_.length&&e++,new Y(n.pieces_,e)}function Ho(n){return n.pieceNum_<n.pieces_.length?n.pieces_[n.pieces_.length-1]:null}function uu(n){let e="";for(let t=n.pieceNum_;t<n.pieces_.length;t++)n.pieces_[t]!==""&&(e+="/"+encodeURIComponent(String(n.pieces_[t])));return e||"/"}function Uo(n,e=0){return n.pieces_.slice(n.pieceNum_+e)}function Wo(n){if(n.pieceNum_>=n.pieces_.length)return null;const e=[];for(let t=n.pieceNum_;t<n.pieces_.length-1;t++)e.push(n.pieces_[t]);return new Y(e,0)}function ne(n,e){const t=[];for(let s=n.pieceNum_;s<n.pieces_.length;s++)t.push(n.pieces_[s]);if(e instanceof Y)for(let s=e.pieceNum_;s<e.pieces_.length;s++)t.push(e.pieces_[s]);else{const s=e.split("/");for(let i=0;i<s.length;i++)s[i].length>0&&t.push(s[i])}return new Y(t,0)}function U(n){return n.pieceNum_>=n.pieces_.length}function ue(n,e){const t=$(n),s=$(e);if(t===null)return e;if(t===s)return ue(J(n),J(e));throw new Error("INTERNAL ERROR: innerPath ("+e+") is not within outerPath ("+n+")")}function Bs(n,e){if(je(n)!==je(e))return!1;for(let t=n.pieceNum_,s=e.pieceNum_;t<=n.pieces_.length;t++,s++)if(n.pieces_[t]!==e.pieces_[s])return!1;return!0}function Ee(n,e){let t=n.pieceNum_,s=e.pieceNum_;if(je(n)>je(e))return!1;for(;t<n.pieces_.length;){if(n.pieces_[t]!==e.pieces_[s])return!1;++t,++s}return!0}class du{constructor(e,t){this.errorPrefix_=t,this.parts_=Uo(e,0),this.byteLength_=Math.max(1,this.parts_.length);for(let s=0;s<this.parts_.length;s++)this.byteLength_+=Ln(this.parts_[s]);Vo(this)}}function fu(n,e){n.parts_.length>0&&(n.byteLength_+=1),n.parts_.push(e),n.byteLength_+=Ln(e),Vo(n)}function _u(n){const e=n.parts_.pop();n.byteLength_-=Ln(e),n.parts_.length>0&&(n.byteLength_-=1)}function Vo(n){if(n.byteLength_>or)throw new Error(n.errorPrefix_+"has a key path longer than "+or+" bytes ("+n.byteLength_+").");if(n.parts_.length>rr)throw new Error(n.errorPrefix_+"path specified exceeds the maximum depth that can be written ("+rr+") or object contains a cycle "+Ye(n))}function Ye(n){return n.parts_.length===0?"":"in property '"+n.parts_.join(".")+"'"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ln;class jo extends Fn{static get __EMPTY_NODE(){return ln}static set __EMPTY_NODE(e){ln=e}compare(e,t){return kt(e.name,t.name)}isDefinedOn(e){throw Rt("KeyIndex.isDefinedOn not expected to be called.")}indexedValueChanged(e,t){return!1}minPost(){return H.MIN}maxPost(){return new H(tt,ln)}makePost(e,t){return m(typeof e=="string","KeyIndex indexValue must always be a string."),new H(e,ln)}toString(){return".key"}}const wt=new jo;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let vs;function wu(n){vs=n}const zo=function(n){return typeof n=="number"?"number:"+wo(n):"string:"+n},qo=function(n){if(n.isLeafNode()){const e=n.val();m(typeof e=="string"||typeof e=="number"||typeof e=="object"&&Le(e,".sv"),"Priority must be a string or number.")}else m(n===vs||n.isEmpty(),"priority of unexpected type.");m(n===vs||n.getPriority().isEmpty(),"Priority nodes can't have a priority of their own.")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let cr;class se{constructor(e,t=se.__childrenNodeConstructor.EMPTY_NODE){this.value_=e,this.priorityNode_=t,this.lazyHash_=null,m(this.value_!==void 0&&this.value_!==null,"LeafNode shouldn't be created with null/undefined value."),qo(this.priorityNode_)}static set __childrenNodeConstructor(e){cr=e}static get __childrenNodeConstructor(){return cr}isLeafNode(){return!0}getPriority(){return this.priorityNode_}updatePriority(e){return new se(this.value_,e)}getImmediateChild(e){return e===".priority"?this.priorityNode_:se.__childrenNodeConstructor.EMPTY_NODE}getChild(e){return U(e)?this:$(e)===".priority"?this.priorityNode_:se.__childrenNodeConstructor.EMPTY_NODE}hasChild(){return!1}getPredecessorChildName(e,t){return null}updateImmediateChild(e,t){return e===".priority"?this.updatePriority(t):t.isEmpty()&&e!==".priority"?this:se.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e,t).updatePriority(this.priorityNode_)}updateChild(e,t){const s=$(e);return s===null?t:t.isEmpty()&&s!==".priority"?this:(m(s!==".priority"||je(e)===1,".priority must be the last token in a path"),this.updateImmediateChild(s,se.__childrenNodeConstructor.EMPTY_NODE.updateChild(J(e),t)))}isEmpty(){return!1}numChildren(){return 0}forEachChild(e,t){return!1}val(e){return e&&!this.getPriority().isEmpty()?{".value":this.getValue(),".priority":this.getPriority().val()}:this.getValue()}hash(){if(this.lazyHash_===null){let e="";this.priorityNode_.isEmpty()||(e+="priority:"+zo(this.priorityNode_.val())+":");const t=typeof this.value_;e+=t+":",t==="number"?e+=wo(this.value_):e+=this.value_,this.lazyHash_=yo(e)}return this.lazyHash_}getValue(){return this.value_}compareTo(e){return e===se.__childrenNodeConstructor.EMPTY_NODE?1:e instanceof se.__childrenNodeConstructor?-1:(m(e.isLeafNode(),"Unknown node type"),this.compareToLeafNode_(e))}compareToLeafNode_(e){const t=typeof e.value_,s=typeof this.value_,i=se.VALUE_TYPE_ORDER.indexOf(t),r=se.VALUE_TYPE_ORDER.indexOf(s);return m(i>=0,"Unknown leaf type: "+t),m(r>=0,"Unknown leaf type: "+s),i===r?s==="object"?0:this.value_<e.value_?-1:this.value_===e.value_?0:1:r-i}withIndex(){return this}isIndexed(){return!0}equals(e){if(e===this)return!0;if(e.isLeafNode()){const t=e;return this.value_===t.value_&&this.priorityNode_.equals(t.priorityNode_)}else return!1}}se.VALUE_TYPE_ORDER=["object","boolean","number","string"];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Go,Ko;function Eu(n){Go=n}function Iu(n){Ko=n}class bu extends Fn{compare(e,t){const s=e.node.getPriority(),i=t.node.getPriority(),r=s.compareTo(i);return r===0?kt(e.name,t.name):r}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return H.MIN}maxPost(){return new H(tt,new se("[PRIORITY-POST]",Ko))}makePost(e,t){const s=Go(e);return new H(t,new se("[PRIORITY-POST]",s))}toString(){return".priority"}}const te=new bu;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yo(n){return{type:"value",snapshotNode:n}}function Tt(n,e){return{type:"child_added",snapshotNode:e,childName:n}}function qt(n,e){return{type:"child_removed",snapshotNode:e,childName:n}}function Gt(n,e,t){return{type:"child_changed",snapshotNode:e,childName:n,oldSnap:t}}function Pu(n,e){return{type:"child_moved",snapshotNode:e,childName:n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Us{constructor(e){this.index_=e}updateChild(e,t,s,i,r,o){m(e.isIndexed(this.index_),"A node must be indexed if only a child is updated");const a=e.getImmediateChild(t);return a.getChild(i).equals(s.getChild(i))&&a.isEmpty()===s.isEmpty()||(o!=null&&(s.isEmpty()?e.hasChild(t)?o.trackChildChange(qt(t,a)):m(e.isLeafNode(),"A child remove without an old child only makes sense on a leaf node"):a.isEmpty()?o.trackChildChange(Tt(t,s)):o.trackChildChange(Gt(t,s,a))),e.isLeafNode()&&s.isEmpty())?e:e.updateImmediateChild(t,s).withIndex(this.index_)}updateFullNode(e,t,s){return s!=null&&(e.isLeafNode()||e.forEachChild(te,(i,r)=>{t.hasChild(i)||s.trackChildChange(qt(i,r))}),t.isLeafNode()||t.forEachChild(te,(i,r)=>{if(e.hasChild(i)){const o=e.getImmediateChild(i);o.equals(r)||s.trackChildChange(Gt(i,r,o))}else s.trackChildChange(Tt(i,r))})),t.withIndex(this.index_)}updatePriority(e,t){return e.isEmpty()?M.EMPTY_NODE:e.updatePriority(t)}filtersNodes(){return!1}getIndexedFilter(){return this}getIndex(){return this.index_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fu{constructor(e){this.collection_=e,this.last_=null}get(){const e=this.collection_.get(),t=Object.assign({},e);return this.last_&&pe(this.last_,(s,i)=>{t[s]=t[s]-i}),this.last_=e,t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dr=10*1e3,Bu=30*1e3,$u=5*60*1e3;class Hu{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Fu(e);const s=dr+(Bu-dr)*Math.random();Bt(this.reportStats_.bind(this),Math.floor(s))}reportStats_(){const e=this.statsListener_.get(),t={};let s=!1;pe(e,(i,r)=>{r>0&&Le(this.statsToReport_,i)&&(t[i]=r,s=!0)}),s&&this.server_.reportStats(t),Bt(this.reportStats_.bind(this),Math.floor(Math.random()*2*$u))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Ie;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(Ie||(Ie={}));function Xo(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function Vs(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function js(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Uu{constructor(e){this.query_=e,this.index_=this.query_._queryParams.getIndex()}}function Wu(n,e,t,s){const i=[],r=[];return e.forEach(o=>{o.type==="child_changed"&&n.index_.indexedValueChanged(o.oldSnap,o.snapshotNode)&&r.push(Pu(o.childName,o.snapshotNode))}),Ot(n,i,"child_removed",e,s,t),Ot(n,i,"child_added",e,s,t),Ot(n,i,"child_moved",r,s,t),Ot(n,i,"child_changed",e,s,t),Ot(n,i,"value",e,s,t),i}function Ot(n,e,t,s,i,r){const o=s.filter(a=>a.type===t);o.sort((a,l)=>ju(n,a,l)),o.forEach(a=>{const l=Vu(n,a,r);i.forEach(c=>{c.respondsTo(a.type)&&e.push(c.createEvent(l,n.query_))})})}function Vu(n,e,t){return e.type==="value"||e.type==="child_removed"||(e.prevName=t.getPredecessorChildName(e.childName,e.snapshotNode,n.index_)),e}function ju(n,e,t){if(e.childName==null||t.childName==null)throw Rt("Should only compare child_ events.");const s=new H(e.childName,e.snapshotNode),i=new H(t.childName,t.snapshotNode);return n.index_.compare(s,i)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rd{constructor(){this.changeMap=new Map}trackChildChange(e){const t=e.type,s=e.childName;m(t==="child_added"||t==="child_changed"||t==="child_removed","Only child changes supported for tracking"),m(s!==".priority","Only non-priority child changes can be tracked.");const i=this.changeMap.get(s);if(i){const r=i.type;if(t==="child_added"&&r==="child_removed")this.changeMap.set(s,Gt(s,e.snapshotNode,i.snapshotNode));else if(t==="child_removed"&&r==="child_added")this.changeMap.delete(s);else if(t==="child_removed"&&r==="child_changed")this.changeMap.set(s,qt(s,i.oldSnap));else if(t==="child_changed"&&r==="child_added")this.changeMap.set(s,Tt(s,e.snapshotNode));else if(t==="child_changed"&&r==="child_changed")this.changeMap.set(s,Gt(s,e.snapshotNode,i.oldSnap));else throw Rt("Illegal combination of changes: "+e+" occurred after "+i)}else this.changeMap.set(s,e)}getChanges(){return Array.from(this.changeMap.values())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class od{getCompleteChild(e){return null}getChildAfterChild(e,t,s){return null}}const ia=new od;class Ks{constructor(e,t,s=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=s}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const s=this.optCompleteServerCache_!=null?new st(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return Gs(this.writes_,e,s)}}getChildAfterChild(e,t,s){const i=this.optCompleteServerCache_!=null?this.optCompleteServerCache_:it(this.viewCache_),r=id(this.writes_,i,t,1,s,e);return r.length===0?null:r[0]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ad(n){return{filter:n}}function ld(n,e){m(e.eventCache.getNode().isIndexed(n.filter.getIndex()),"Event snap not indexed"),m(e.serverCache.getNode().isIndexed(n.filter.getIndex()),"Server snap not indexed")}function cd(n,e,t,s,i){const r=new rd;let o,a;if(t.type===Ie.OVERWRITE){const c=t;c.source.fromUser?o=bs(n,e,c.path,c.snap,s,i,r):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered()&&!U(c.path),o=bn(n,e,c.path,c.snap,s,i,a,r))}else if(t.type===Ie.MERGE){const c=t;c.source.fromUser?o=ud(n,e,c.path,c.children,s,i,r):(m(c.source.fromServer,"Unknown source."),a=c.source.tagged||e.serverCache.isFiltered(),o=Ts(n,e,c.path,c.children,s,i,a,r))}else if(t.type===Ie.ACK_USER_WRITE){const c=t;c.revert?o=_d(n,e,c.path,s,i,r):o=dd(n,e,c.path,c.affectedTree,s,i,r)}else if(t.type===Ie.LISTEN_COMPLETE)o=fd(n,e,t.path,s,r);else throw Rt("Unknown operation type: "+t.type);const l=r.getChanges();return hd(e,o,l),{viewCache:o,changes:l}}function hd(n,e,t){const s=e.eventCache;if(s.isFullyInitialized()){const i=s.getNode().isLeafNode()||s.getNode().isEmpty(),r=ws(n);(t.length>0||!n.eventCache.isFullyInitialized()||i&&!s.getNode().equals(r)||!s.getNode().getPriority().equals(r.getPriority()))&&t.push(Yo(ws(e)))}}function ra(n,e,t,s,i,r){const o=e.eventCache;if(In(s,t)!=null)return e;{let a,l;if(U(t))if(m(e.serverCache.isFullyInitialized(),"If change path is empty, we must have complete server data"),e.serverCache.isFiltered()){const c=it(e),h=c instanceof M?c:M.EMPTY_NODE,u=qs(s,h);a=n.filter.updateFullNode(e.eventCache.getNode(),u,r)}else{const c=En(s,it(e));a=n.filter.updateFullNode(e.eventCache.getNode(),c,r)}else{const c=$(t);if(c===".priority"){m(je(t)===1,"Can't have a priority with additional path components");const h=o.getNode();l=e.serverCache.getNode();const u=mr(s,t,h,l);u!=null?a=n.filter.updatePriority(h,u):a=o.getNode()}else{const h=J(t);let u;if(o.isCompleteForChild(c)){l=e.serverCache.getNode();const d=mr(s,t,o.getNode(),l);d!=null?u=o.getNode().getImmediateChild(c).updateChild(h,d):u=o.getNode().getImmediateChild(c)}else u=Gs(s,c,e.serverCache);u!=null?a=n.filter.updateChild(o.getNode(),c,u,h,i,r):a=o.getNode()}}return $t(e,a,o.isFullyInitialized()||U(t),n.filter.filtersNodes())}}function bn(n,e,t,s,i,r,o,a){const l=e.serverCache;let c;const h=o?n.filter:n.filter.getIndexedFilter();if(U(t))c=h.updateFullNode(l.getNode(),s,null);else if(h.filtersNodes()&&!l.isFiltered()){const f=l.getNode().updateChild(t,s);c=h.updateFullNode(l.getNode(),f,null)}else{const f=$(t);if(!l.isCompleteForPath(t)&&je(t)>1)return e;const _=J(t),g=l.getNode().getImmediateChild(f).updateChild(_,s);f===".priority"?c=h.updatePriority(l.getNode(),g):c=h.updateChild(l.getNode(),f,g,_,ia,null)}const u=Jo(e,c,l.isFullyInitialized()||U(t),h.filtersNodes()),d=new Ks(i,u,r);return ra(n,u,t,i,d,a)}function bs(n,e,t,s,i,r,o){const a=e.eventCache;let l,c;const h=new Ks(i,e,r);if(U(t))c=n.filter.updateFullNode(e.eventCache.getNode(),s,o),l=$t(e,c,!0,n.filter.filtersNodes());else{const u=$(t);if(u===".priority")c=n.filter.updatePriority(e.eventCache.getNode(),s),l=$t(e,c,a.isFullyInitialized(),a.isFiltered());else{const d=J(t),f=a.getNode().getImmediateChild(u);let _;if(U(d))_=s;else{const v=h.getCompleteChild(u);v!=null?Ho(d)===".priority"&&v.getChild(Wo(d)).isEmpty()?_=v:_=v.updateChild(d,s):_=M.EMPTY_NODE}if(f.equals(_))l=e;else{const v=n.filter.updateChild(a.getNode(),u,_,d,h,o);l=$t(e,v,a.isFullyInitialized(),n.filter.filtersNodes())}}}return l}function gr(n,e){return n.eventCache.isCompleteForChild(e)}function ud(n,e,t,s,i,r,o){let a=e;return s.foreach((l,c)=>{const h=ne(t,l);gr(e,$(h))&&(a=bs(n,a,h,c,i,r,o))}),s.foreach((l,c)=>{const h=ne(t,l);gr(e,$(h))||(a=bs(n,a,h,c,i,r,o))}),a}function yr(n,e,t){return t.foreach((s,i)=>{e=e.updateChild(s,i)}),e}function Ts(n,e,t,s,i,r,o,a){if(e.serverCache.getNode().isEmpty()&&!e.serverCache.isFullyInitialized())return e;let l=e,c;U(t)?c=s:c=new Z(null).setTree(t,s);const h=e.serverCache.getNode();return c.children.inorderTraversal((u,d)=>{if(h.hasChild(u)){const f=e.serverCache.getNode().getImmediateChild(u),_=yr(n,f,d);l=bn(n,l,new Y(u),_,i,r,o,a)}}),c.children.inorderTraversal((u,d)=>{const f=!e.serverCache.isCompleteForChild(u)&&d.value===null;if(!h.hasChild(u)&&!f){const _=e.serverCache.getNode().getImmediateChild(u),v=yr(n,_,d);l=bn(n,l,new Y(u),v,i,r,o,a)}}),l}function dd(n,e,t,s,i,r,o){if(In(i,t)!=null)return e;const a=e.serverCache.isFiltered(),l=e.serverCache;if(s.value!=null){if(U(t)&&l.isFullyInitialized()||l.isCompleteForPath(t))return bn(n,e,t,l.getNode().getChild(t),i,r,a,o);if(U(t)){let c=new Z(null);return l.getNode().forEachChild(wt,(h,u)=>{c=c.set(new Y(h),u)}),Ts(n,e,t,c,i,r,a,o)}else return e}else{let c=new Z(null);return s.foreach((h,u)=>{const d=ne(t,h);l.isCompleteForPath(d)&&(c=c.set(h,l.getNode().getChild(d)))}),Ts(n,e,t,c,i,r,a,o)}}function fd(n,e,t,s,i){const r=e.serverCache,o=Jo(e,r.getNode(),r.isFullyInitialized()||U(t),r.isFiltered());return ra(n,o,t,s,ia,i)}function _d(n,e,t,s,i,r){let o;if(In(s,t)!=null)return e;{const a=new Ks(s,e,i),l=e.eventCache.getNode();let c;if(U(t)||$(t)===".priority"){let h;if(e.serverCache.isFullyInitialized())h=En(s,it(e));else{const u=e.serverCache.getNode();m(u instanceof M,"serverChildren would be complete if leaf node"),h=qs(s,u)}h=h,c=n.filter.updateFullNode(l,h,r)}else{const h=$(t);let u=Gs(s,h,e.serverCache);u==null&&e.serverCache.isCompleteForChild(h)&&(u=l.getImmediateChild(h)),u!=null?c=n.filter.updateChild(l,h,u,J(t),a,r):e.eventCache.getNode().hasChild(h)?c=n.filter.updateChild(l,h,M.EMPTY_NODE,J(t),a,r):c=l,c.isEmpty()&&e.serverCache.isFullyInitialized()&&(o=En(s,it(e)),o.isLeafNode()&&(c=n.filter.updateFullNode(c,o,r)))}return o=e.serverCache.isFullyInitialized()||In(s,K())!=null,$t(e,c,o,n.filter.filtersNodes())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Tn;class Cd{constructor(){this.views=new Map}}function wd(n){m(!Tn,"__referenceConstructor has already been defined"),Tn=n}function Ed(){return m(Tn,"Reference.ts has not been loaded"),Tn}function Id(n){return n.views.size===0}function Ys(n,e,t,s){const i=e.source.queryId;if(i!==null){const r=n.views.get(i);return m(r!=null,"SyncTree gave us an op for an invalid query."),wr(r,e,t,s)}else{let r=[];for(const o of n.views.values())r=r.concat(wr(o,e,t,s));return r}}function bd(n,e,t,s,i){const r=e._queryIdentifier,o=n.views.get(r);if(!o){let a=En(t,i?s:null),l=!1;a?l=!0:s instanceof M?(a=qs(t,s),l=!1):(a=M.EMPTY_NODE,l=!1);const c=Bn(new st(a,l,!1),new st(s,i,!1));return new pd(e,c)}return o}function Td(n,e,t,s,i,r){const o=bd(n,e,s,i,r);return n.views.has(e._queryIdentifier)||n.views.set(e._queryIdentifier,o),yd(o,t),vd(o,t)}function Sd(n,e,t,s){const i=e._queryIdentifier,r=[];let o=[];const a=ze(n);if(i==="default")for(const[l,c]of n.views.entries())o=o.concat(Cr(c,t,s)),vr(c)&&(n.views.delete(l),c.query._queryParams.loadsAllData()||r.push(c.query));else{const l=n.views.get(i);l&&(o=o.concat(Cr(l,t,s)),vr(l)&&(n.views.delete(i),l.query._queryParams.loadsAllData()||r.push(l.query)))}return a&&!ze(n)&&r.push(new(Ed())(e._repo,e._path)),{removed:r,events:o}}function aa(n){const e=[];for(const t of n.views.values())t.query._queryParams.loadsAllData()||e.push(t);return e}function Et(n,e){let t=null;for(const s of n.views.values())t=t||gd(s,e);return t}function la(n,e){if(e._queryParams.loadsAllData())return $n(n);{const s=e._queryIdentifier;return n.views.get(s)}}function ca(n,e){return la(n,e)!=null}function ze(n){return $n(n)!=null}function $n(n){for(const e of n.views.values())if(e.query._queryParams.loadsAllData())return e;return null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Sn;function Nd(n){m(!Sn,"__referenceConstructor has already been defined"),Sn=n}function Rd(){return m(Sn,"Reference.ts has not been loaded"),Sn}let kd=1;class Er{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Z(null),this.pendingWriteTree_=sd(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function ha(n,e,t,s,i){return qu(n.pendingWriteTree_,e,t,s,i),i?nn(n,new nt(Xo(),e,t)):[]}function Xe(n,e,t=!1){const s=Gu(n.pendingWriteTree_,e);if(Ku(n.pendingWriteTree_,e)){let r=new Z(null);return s.snap!=null?r=r.set(K(),!0):pe(s.children,o=>{r=r.set(new Y(o),!0)}),nn(n,new wn(s.path,r,t))}else return[]}function Hn(n,e,t){return nn(n,new nt(Vs(),e,t))}function Ad(n,e,t){const s=Z.fromObject(t);return nn(n,new Qt(Vs(),e,s))}function Dd(n,e){return nn(n,new Yt(Vs(),e))}function Pd(n,e,t){const s=Xs(n,t);if(s){const i=Js(s),r=i.path,o=i.queryId,a=ue(r,e),l=new Yt(js(o),a);return Zs(n,r,l)}else return[]}function Ss(n,e,t,s,i=!1){const r=e._path,o=n.syncPointTree_.get(r);let a=[];if(o&&(e._queryIdentifier==="default"||ca(o,e))){const l=Sd(o,e,t,s);Id(o)&&(n.syncPointTree_=n.syncPointTree_.remove(r));const c=l.removed;if(a=l.events,!i){const h=c.findIndex(d=>d._queryParams.loadsAllData())!==-1,u=n.syncPointTree_.findOnPath(r,(d,f)=>ze(f));if(h&&!u){const d=n.syncPointTree_.subtree(r);if(!d.isEmpty()){const f=Od(d);for(let _=0;_<f.length;++_){const v=f[_],g=v.query,w=fa(n,v);n.listenProvider_.startListening(Ut(g),Nn(n,g),w.hashFn,w.onComplete)}}}!u&&c.length>0&&!s&&(h?n.listenProvider_.stopListening(Ut(e),null):c.forEach(d=>{const f=n.queryToTagMap.get(Un(d));n.listenProvider_.stopListening(Ut(d),f)}))}Ld(n,c)}return a}function Md(n,e,t,s){const i=Xs(n,s);if(i!=null){const r=Js(i),o=r.path,a=r.queryId,l=ue(o,e),c=new nt(js(a),l,t);return Zs(n,o,c)}else return[]}function xd(n,e,t,s){const i=Xs(n,s);if(i){const r=Js(i),o=r.path,a=r.queryId,l=ue(o,e),c=Z.fromObject(t),h=new Qt(js(a),l,c);return Zs(n,o,h)}else return[]}function Ir(n,e,t,s=!1){const i=e._path;let r=null,o=!1;n.syncPointTree_.foreachOnPath(i,(d,f)=>{const _=ue(d,i);r=r||Et(f,_),o=o||ze(f)});let a=n.syncPointTree_.get(i);a?(o=o||ze(a),r=r||Et(a,K())):(a=new Cd,n.syncPointTree_=n.syncPointTree_.set(i,a));let l;r!=null?l=!0:(l=!1,r=M.EMPTY_NODE,n.syncPointTree_.subtree(i).foreachChild((f,_)=>{const v=Et(_,K());v&&(r=r.updateImmediateChild(f,v))}));const c=ca(a,e);if(!c&&!e._queryParams.loadsAllData()){const d=Un(e);m(!n.queryToTagMap.has(d),"View does not exist, but we have a tag");const f=Fd();n.queryToTagMap.set(d,f),n.tagToQueryMap.set(f,d)}const h=zs(n.pendingWriteTree_,i);let u=Td(a,e,t,h,r,l);if(!c&&!o&&!s){const d=la(a,e);u=u.concat(Bd(n,e,d))}return u}function Qs(n,e,t){const i=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const l=ue(o,e),c=Et(a,l);if(c)return c});return ta(i,e,r,t,!0)}function nn(n,e){return ua(e,n.syncPointTree_,null,zs(n.pendingWriteTree_,K()))}function ua(n,e,t,s){if(U(n.path))return da(n,e,t,s);{const i=e.get(K());t==null&&i!=null&&(t=Et(i,K()));let r=[];const o=$(n.path),a=n.operationForChild(o),l=e.children.get(o);if(l&&a){const c=t?t.getImmediateChild(o):null,h=na(s,o);r=r.concat(ua(a,l,c,h))}return i&&(r=r.concat(Ys(i,n,s,t))),r}}function da(n,e,t,s){const i=e.get(K());t==null&&i!=null&&(t=Et(i,K()));let r=[];return e.children.inorderTraversal((o,a)=>{const l=t?t.getImmediateChild(o):null,c=na(s,o),h=n.operationForChild(o);h&&(r=r.concat(da(h,a,l,c)))}),i&&(r=r.concat(Ys(i,n,s,t))),r}function fa(n,e){const t=e.query,s=Nn(n,t);return{hashFn:()=>(md(e)||M.EMPTY_NODE).hash(),onComplete:i=>{if(i==="ok")return s?Pd(n,t._path,s):Dd(n,t._path);{const r=Mh(i,t);return Ss(n,t,null,r)}}}}function Nn(n,e){const t=Un(e);return n.queryToTagMap.get(t)}function Un(n){return n._path.toString()+"$"+n._queryIdentifier}function Xs(n,e){return n.tagToQueryMap.get(e)}function Js(n){const e=n.indexOf("$");return m(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new Y(n.substr(0,e))}}function Zs(n,e,t){const s=n.syncPointTree_.get(e);m(s,"Missing sync point for query tag that we're tracking");const i=zs(n.pendingWriteTree_,e);return Ys(s,t,i,null)}function Od(n){return n.fold((e,t,s)=>{if(t&&ze(t))return[$n(t)];{let i=[];return t&&(i=aa(t)),pe(s,(r,o)=>{i=i.concat(o)}),i}})}function Ut(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(Rd())(n._repo,n._path):n}function Ld(n,e){for(let t=0;t<e.length;++t){const s=e[t];if(!s._queryParams.loadsAllData()){const i=Un(s),r=n.queryToTagMap.get(i);n.queryToTagMap.delete(i),n.tagToQueryMap.delete(r)}}}function Fd(){return kd++}function Bd(n,e,t){const s=e._path,i=Nn(n,e),r=fa(n,t),o=n.listenProvider_.startListening(Ut(e),i,r.hashFn,r.onComplete),a=n.syncPointTree_.subtree(s);if(i)m(!ze(a.value),"If we're adding a query, it shouldn't be shadowed");else{const l=a.fold((c,h,u)=>{if(!U(c)&&h&&ze(h))return[$n(h).query];{let d=[];return h&&(d=d.concat(aa(h).map(f=>f.query))),pe(u,(f,_)=>{d=d.concat(_)}),d}});for(let c=0;c<l.length;++c){const h=l[c];n.listenProvider_.stopListening(Ut(h),Nn(n,h))}}return o}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qd=/[\[\].#$\/\u0000-\u001F\u007F]/,Gd=/[\[\].#$\u0000-\u001F\u007F]/,is=10*1024*1024,ya=function(n){return typeof n=="string"&&n.length!==0&&!qd.test(n)},va=function(n){return typeof n=="string"&&n.length!==0&&!Gd.test(n)},Kd=function(n){return n&&(n=n.replace(/^\/*\.info(\/|$)/,"/")),va(n)},Ca=function(n,e,t,s){s&&e===void 0||ri(Ds(n,"value"),e,t)},ri=function(n,e,t){const s=t instanceof Y?new du(t,n):t;if(e===void 0)throw new Error(n+"contains undefined "+Ye(s));if(typeof e=="function")throw new Error(n+"contains a function "+Ye(s)+" with contents = "+e.toString());if(vo(e))throw new Error(n+"contains "+e.toString()+" "+Ye(s));if(typeof e=="string"&&e.length>is/3&&Ln(e)>is)throw new Error(n+"contains a string greater than "+is+" utf8 bytes "+Ye(s)+" ('"+e.substring(0,50)+"...')");if(e&&typeof e=="object"){let i=!1,r=!1;if(pe(e,(o,a)=>{if(o===".value")i=!0;else if(o!==".priority"&&o!==".sv"&&(r=!0,!ya(o)))throw new Error(n+" contains an invalid key ("+o+") "+Ye(s)+`.  Keys must be non-empty strings and can't contain ".", "#", "$", "/", "[", or "]"`);fu(s,o),ri(n,a,s),_u(s)}),i&&r)throw new Error(n+' contains ".value" child '+Ye(s)+" in addition to actual children.")}},wa=function(n,e,t,s){if(!(s&&t===void 0)&&!va(t))throw new Error(Ds(n,e)+'was an invalid path = "'+t+`". Paths must be non-empty strings and can't contain ".", "#", "$", "[", or "]"`)},Yd=function(n,e,t,s){t&&(t=t.replace(/^\/*\.info(\/|$)/,"/")),wa(n,e,t,s)},Ea=function(n,e){if($(e)===".info")throw new Error(n+" failed = Can't modify data under /.info/")},Qd=function(n,e){const t=e.path.toString();if(typeof e.repoInfo.host!="string"||e.repoInfo.host.length===0||!ya(e.repoInfo.namespace)&&e.repoInfo.host.split(":")[0]!=="localhost"||t.length!==0&&!Kd(t))throw new Error(Ds(n,"url")+`must be a valid firebase URL and the path can't contain ".", "#", "$", "[", or "]".`)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ba=1e4,$a=`w:${_i}`,Ha="FIS_v2",Df="https://firebaseinstallations.googleapis.com/v1",Pf=60*60*1e3,Mf="installations",xf="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $f({appConfig:n,heartbeatServiceProvider:e},{fid:t}){const s=Wa(n),i=za(n),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={fid:t,authVersion:Ha,appId:n.appId,sdkVersion:$a},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await qa(()=>fetch(s,a));if(l.ok){const c=await l.json();return{fid:c.fid||t,registrationStatus:2,refreshToken:c.refreshToken,authToken:Va(c.authToken)}}else throw await ja("Create Installation",l)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ka=new Map;function Ya(n,e){const t=zn(n);Qa(t,e),jf(t,e)}function Qa(n,e){const t=Ka.get(n);if(t)for(const s of t)s(e)}function jf(n,e){const t=zf();t&&t.postMessage({key:n,fid:e}),qf()}let Je=null;function zf(){return!Je&&"BroadcastChannel"in self&&(Je=new BroadcastChannel("[Firebase] FID Change"),Je.onmessage=n=>{Qa(n.data.key,n.data.fid)}),Je}function qf(){Ka.size===0&&Je&&(Je.close(),Je=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gf="firebase-installations-database",Kf=1,ot="firebase-installations-store";let os=null;function pi(){return os||(os=ho(Gf,Kf,{upgrade:(n,e)=>{switch(e){case 0:n.createObjectStore(ot)}}})),os}async function Rn(n,e){const t=zn(n),i=(await pi()).transaction(ot,"readwrite"),r=i.objectStore(ot),o=await r.get(t);return await r.put(e,t),await i.done,(!o||o.fid!==e.fid)&&Ya(n,e.fid),e}async function Xa(n){const e=zn(n),s=(await pi()).transaction(ot,"readwrite");await s.objectStore(ot).delete(e),await s.done}async function qn(n,e){const t=zn(n),i=(await pi()).transaction(ot,"readwrite"),r=i.objectStore(ot),o=await r.get(t),a=e(o);return a===void 0?await r.delete(t):await r.put(a,t),await i.done,a&&(!o||o.fid!==a.fid)&&Ya(n,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e_({appConfig:n,heartbeatServiceProvider:e},t){const s=t_(n,t),i=Lf(n,t),r=e.getImmediate({optional:!0});if(r){const c=await r.getHeartbeatsHeader();c&&i.append("x-firebase-client",c)}const o={installation:{sdkVersion:$a,appId:n.appId}},a={method:"POST",headers:i,body:JSON.stringify(o)},l=await qa(()=>fetch(s,a));if(l.ok){const c=await l.json();return Va(c)}else throw await ja("Generate Auth Token",l)}function t_(n,{fid:e}){return`${Wa(n)}/${e}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gi(n,e=!1){let t;const s=await qn(n.appConfig,r=>{if(!Za(r))throw rt.create("not-registered");const o=r.authToken;if(!e&&i_(o))return r;if(o.requestStatus===1)return t=n_(n,e),r;{if(!navigator.onLine)throw rt.create("app-offline");const a=o_(r);return t=s_(n,a),a}});return t?await t:s.authToken}async function n_(n,e){let t=await Dr(n.appConfig);for(;t.authToken.requestStatus===1;)await Ga(100),t=await Dr(n.appConfig);const s=t.authToken;return s.requestStatus===0?gi(n,e):s}function Dr(n){return qn(n,e=>{if(!Za(e))throw rt.create("not-registered");const t=e.authToken;return a_(t)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function s_(n,e){try{const t=await e_(n,e),s=Object.assign(Object.assign({},e),{authToken:t});return await Rn(n.appConfig,s),t}catch(t){if(Ua(t)&&(t.customData.serverCode===401||t.customData.serverCode===404))await Xa(n.appConfig);else{const s=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await Rn(n.appConfig,s)}throw t}}function Za(n){return n!==void 0&&n.registrationStatus===2}function i_(n){return n.requestStatus===2&&!r_(n)}function r_(n){const e=Date.now();return e<n.creationTime||n.creationTime+n.expiresIn<e+Pf}function o_(n){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},n),{authToken:e})}function a_(n){return n.requestStatus===1&&n.requestTime+Ba<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function l_(n){const e=n,{installationEntry:t,registrationPromise:s}=await mi(e);return s?s.catch(console.error):gi(e).catch(console.error),t.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function c_(n,e=!1){const t=n;return await h_(t),(await gi(t,e)).token}async function h_(n){const{registrationPromise:e}=await mi(n);e&&await e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function u_(n){if(!n||!n.options)throw as("App Configuration");if(!n.name)throw as("App Name");const e=["projectId","apiKey","appId"];for(const t of e)if(!n.options[t])throw as(t);return{appName:n.name,projectId:n.options.projectId,apiKey:n.options.apiKey,appId:n.options.appId}}function as(n){return rt.create("missing-app-config-values",{valueName:n})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const el="installations",d_="installations-internal",f_=n=>{const e=n.getProvider("app").getImmediate(),t=u_(e),s=Jt(e,"heartbeat");return{app:e,appConfig:t,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},__=n=>{const e=n.getProvider("app").getImmediate(),t=Jt(e,el).getImmediate();return{getId:()=>l_(t),getToken:i=>c_(t,i)}};function p_(){Ve(new Me(el,f_,"PUBLIC")),Ve(new Me(d_,__,"PRIVATE"))}p_();Ne(Fa,_i);Ne(Fa,_i,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kn="analytics",m_="firebase_id",g_="origin",y_=60*1e3,v_="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",yi="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e=new Ps("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function w_(n){if(!n.startsWith(yi)){const e=ve.create("invalid-gtag-resource",{gtagURL:n});return _e.warn(e.message),""}return n}function tl(n){return Promise.all(n.map(e=>e.catch(t=>t)))}function E_(n,e){let t;return window.trustedTypes&&(t=window.trustedTypes.createPolicy(n,e)),t}function I_(n,e){const t=E_("firebase-js-sdk-policy",{createScriptURL:w_}),s=document.createElement("script"),i=`${yi}?l=${n}&id=${e}`;s.src=t?t==null?void 0:t.createScriptURL(i):i,s.async=!0,document.head.appendChild(s)}function b_(n){let e=[];return Array.isArray(window[n])?e=window[n]:window[n]=e,e}async function T_(n,e,t,s,i,r){const o=s[i];try{if(o)await e[o];else{const l=(await tl(t)).find(c=>c.measurementId===i);l&&await e[l.appId]}}catch(a){_e.error(a)}n("config",i,r)}async function S_(n,e,t,s,i){try{let r=[];if(i&&i.send_to){let o=i.send_to;Array.isArray(o)||(o=[o]);const a=await tl(t);for(const l of o){const c=a.find(u=>u.measurementId===l),h=c&&e[c.appId];if(h)r.push(h);else{r=[];break}}}r.length===0&&(r=Object.values(e)),await Promise.all(r),n("event",s,i||{})}catch(r){_e.error(r)}}function N_(n,e,t,s){async function i(r,...o){try{if(r==="event"){const[a,l]=o;await S_(n,e,t,a,l)}else if(r==="config"){const[a,l]=o;await T_(n,e,t,s,a,l)}else if(r==="consent"){const[a]=o;n("consent","update",a)}else if(r==="get"){const[a,l,c]=o;n("get",a,l,c)}else if(r==="set"){const[a]=o;n("set",a)}else n(r,...o)}catch(a){_e.error(a)}}return i}function R_(n,e,t,s,i){let r=function(...o){window[s].push(arguments)};return window[i]&&typeof window[i]=="function"&&(r=window[i]),window[i]=N_(r,n,e,t),{gtagCore:r,wrappedGtag:window[i]}}function k_(n){const e=window.document.getElementsByTagName("script");for(const t of Object.values(e))if(t.src&&t.src.includes(yi)&&t.src.includes(n))return t;return null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A_=30,D_=1e3;class P_{constructor(e={},t=D_){this.throttleMetadata=e,this.intervalMillis=t}getThrottleMetadata(e){return this.throttleMetadata[e]}setThrottleMetadata(e,t){this.throttleMetadata[e]=t}deleteThrottleMetadata(e){delete this.throttleMetadata[e]}}const nl=new P_;function M_(n){return new Headers({Accept:"application/json","x-goog-api-key":n})}async function x_(n){var e;const{appId:t,apiKey:s}=n,i={method:"GET",headers:M_(s)},r=v_.replace("{app-id}",t),o=await fetch(r,i);if(o.status!==200&&o.status!==304){let a="";try{const l=await o.json();!((e=l.error)===null||e===void 0)&&e.message&&(a=l.error.message)}catch{}throw ve.create("config-fetch-failed",{httpStatus:o.status,responseMessage:a})}return o.json()}async function O_(n,e=nl,t){const{appId:s,apiKey:i,measurementId:r}=n.options;if(!s)throw ve.create("no-app-id");if(!i){if(r)return{measurementId:r,appId:s};throw ve.create("no-api-key")}const o=e.getThrottleMetadata(s)||{backoffCount:0,throttleEndTimeMillis:Date.now()},a=new B_;return setTimeout(async()=>{a.abort()},t!==void 0?t:y_),sl({appId:s,apiKey:i,measurementId:r},o,a,e)}async function sl(n,{throttleEndTimeMillis:e,backoffCount:t},s,i=nl){var r;const{appId:o,measurementId:a}=n;try{await L_(s,e)}catch(l){if(a)return _e.warn(`Timed out fetching this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${l==null?void 0:l.message}]`),{appId:o,measurementId:a};throw l}try{const l=await x_(n);return i.deleteThrottleMetadata(o),l}catch(l){const c=l;if(!F_(c)){if(i.deleteThrottleMetadata(o),a)return _e.warn(`Failed to fetch this Firebase app's measurement ID from the server. Falling back to the measurement ID ${a} provided in the "measurementId" field in the local Firebase config. [${c==null?void 0:c.message}]`),{appId:o,measurementId:a};throw l}const h=Number((r=c==null?void 0:c.customData)===null||r===void 0?void 0:r.httpStatus)===503?$i(t,i.intervalMillis,A_):$i(t,i.intervalMillis),u={throttleEndTimeMillis:Date.now()+h,backoffCount:t+1};return i.setThrottleMetadata(o,u),_e.debug(`Calling attemptFetch again in ${h} millis`),sl(n,u,s,i)}}function L_(n,e){return new Promise((t,s)=>{const i=Math.max(e-Date.now(),0),r=setTimeout(t,i);n.addEventListener(()=>{clearTimeout(r),s(ve.create("fetch-throttle",{throttleEndTimeMillis:e}))})})}function F_(n){if(!(n instanceof at)||!n.customData)return!1;const e=Number(n.customData.httpStatus);return e===429||e===500||e===503||e===504}class B_{constructor(){this.listeners=[]}addEventListener(e){this.listeners.push(e)}abort(){this.listeners.forEach(e=>e())}}async function $_(n,e,t,s,i){if(i&&i.global){n("event",t,s);return}else{const r=await e,o=Object.assign(Object.assign({},s),{send_to:r});n("event",t,o)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function H_(){if(ro())try{await oo()}catch(n){return _e.warn(ve.create("indexeddb-unavailable",{errorInfo:n==null?void 0:n.toString()}).message),!1}else return _e.warn(ve.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function U_(n,e,t,s,i,r,o){var a;const l=O_(n);l.then(f=>{t[f.measurementId]=f.appId,n.options.measurementId&&f.measurementId!==n.options.measurementId&&_e.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${f.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(f=>_e.error(f)),e.push(l);const c=H_().then(f=>{if(f)return s.getId()}),[h,u]=await Promise.all([l,c]);k_(r)||I_(r,h.measurementId),i("js",new Date);const d=(a=o==null?void 0:o.config)!==null&&a!==void 0?a:{};return d[g_]="firebase",d.update=!0,u!=null&&(d[m_]=u),i("config",h.measurementId,d),h.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W_{constructor(e){this.app=e}_delete(){return delete Wt[this.app.options.appId],Promise.resolve()}}let Wt={},Pr=[];const Mr={};let ls="dataLayer",V_="gtag",xr,il,Or=!1;function j_(){const n=[];if(Zl()&&n.push("This is a browser extension environment."),tc()||n.push("Cookies are not available."),n.length>0){const e=n.map((s,i)=>`(${i+1}) ${s}`).join(" "),t=ve.create("invalid-analytics-context",{errorInfo:e});_e.warn(t.message)}}function z_(n,e,t){j_();const s=n.options.appId;if(!s)throw ve.create("no-app-id");if(!n.options.apiKey)if(n.options.measurementId)_e.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${n.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw ve.create("no-api-key");if(Wt[s]!=null)throw ve.create("already-exists",{id:s});if(!Or){b_(ls);const{wrappedGtag:r,gtagCore:o}=R_(Wt,Pr,Mr,ls,V_);il=r,xr=o,Or=!0}return Wt[s]=U_(n,Pr,Mr,e,xr,ls,t),new W_(n)}function q_(n=fo()){n=qe(n);const e=Jt(n,kn);return e.isInitialized()?e.getImmediate():G_(n)}function G_(n,e={}){const t=Jt(n,kn);if(t.isInitialized()){const i=t.getImmediate();if(_n(e,t.getOptions()))return i;throw ve.create("already-initialized")}return t.initialize({options:e})}function rl(n,e,t,s){n=qe(n),$_(il,Wt[n.app.options.appId],e,t,s).catch(i=>_e.error(i))}const Lr="@firebase/analytics",Fr="0.10.1";function K_(){Ve(new Me(kn,(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("installations-internal").getImmediate();return z_(s,i,t)},"PUBLIC")),Ve(new Me("analytics-internal",n,"PRIVATE")),Ne(Lr,Fr),Ne(Lr,Fr,"esm2017");function n(e){try{const t=e.getProvider(kn).getImmediate();return{logEvent:(s,i,r)=>rl(t,s,i,r)}}catch(t){throw ve.create("interop-component-reg-failed",{reason:t})}}}K_();function Y_(n){let e,t,s=ke(n[2])+"",i,r,o,a=ke(n[1])+"",l,c,h,u=ke(n[0])+"",d;return{c(){e=b("span"),t=b("span"),i=me(s),r=me(":"),o=b("span"),l=me(a),c=me(":"),h=b("span"),d=me(u),this.h()},l(f){e=T(f,"SPAN",{class:!0});var _=q(e);t=T(_,"SPAN",{class:!0});var v=q(t);i=ge(v,s),v.forEach(y),r=ge(_,":"),o=T(_,"SPAN",{class:!0});var g=q(o);l=ge(g,a),g.forEach(y),c=ge(_,":"),h=T(_,"SPAN",{class:!0});var w=q(h);d=ge(w,u),w.forEach(y),_.forEach(y),this.h()},h(){P(t,"class","value"),P(o,"class","value"),P(h,"class","value"),P(e,"class","timer svelte-1y1osaq")},m(f,_){D(f,e,_),I(e,t),I(t,i),I(e,r),I(e,o),I(o,l),I(e,c),I(e,h),I(h,d)},p(f,[_]){_&4&&s!==(s=ke(f[2])+"")&&De(i,s),_&2&&a!==(a=ke(f[1])+"")&&De(l,a),_&1&&u!==(u=ke(f[0])+"")&&De(d,u)},i:ye,o:ye,d(f){f&&y(e)}}}function ke(n){return n<10?`0${n}`:n.toString()}function Q_(n,e,t){let s,i,r,o,a,l,{elapsedSeconds:c}=e,h=Date.now(),u=cs(!1);hn(n,u,w=>t(12,o=w));let d=cs(0);hn(n,d,w=>t(13,a=w));const f=bl(0,function(F){const S=setInterval(()=>{o&&(d.set(Math.round((Date.now()-h)/1e3)),F(a))},1e3);return function(){clearInterval(S)}});hn(n,f,w=>t(10,l=w));function _(){o||(h=Date.now()-a*1e3,u.set(!0))}function v(){o&&u.set(!1)}function g(){v(),h=Date.now(),d.set(0)}return n.$$set=w=>{"elapsedSeconds"in w&&t(6,c=w.elapsedSeconds)},n.$$.update=()=>{n.$$.dirty&1024&&t(2,s=Math.floor(l/3600)),n.$$.dirty&1028&&t(1,i=Math.floor((l-s*3600)/60)),n.$$.dirty&1030&&t(0,r=l-s*3600-i*60),n.$$.dirty&7&&t(6,c=ke(s)+":"+ke(i)+":"+ke(r))},[r,i,s,u,d,f,c,_,v,g,l]}class X_ extends Pn{constructor(e){super(),Mn(this,e,Q_,Y_,Dn,{elapsedSeconds:6,start:7,stop:8,reset:9})}get start(){return this.$$.ctx[7]}get stop(){return this.$$.ctx[8]}get reset(){return this.$$.ctx[9]}}function Br(n,e,t){const s=n.slice();return s[31]=e[t],s}function $r(n,e,t){const s=n.slice();return s[34]=e[t],s[36]=t,s}function Hr(n,e,t){const s=n.slice();return s[34]=e[t],s[36]=t,s}function J_(n){let e,t="Loading Game...";return{c(){e=b("p"),e.textContent=t},l(s){e=T(s,"P",{"data-svelte-h":!0}),ee(e)!=="svelte-kk77ic"&&(e.textContent=t)},m(s,i){D(s,e,i)},p:ye,d(s){s&&y(e)}}}function Z_(n){let e,t,s,i=[],r=new Map,o,a,l='<i class="fa-solid fa-eraser"></i>',c,h,u='<i class="fa-solid fa-shuffle"></i>',d,f,_='<i class="fa-solid fa-delete-left"></i>',v,g,w="Enter",F,R,S,V,B,N,C=$e(n[4]),E=[];for(let k=0;k<C.length;k+=1)E[k]=Ur(Hr(n,C,k));let x=$e(n[5]);const Q=k=>k[36];for(let k=0;k<x.length;k+=1){let G=$r(n,x,k),p=Q(G);r.set(p,i[k]=Wr(p,G))}return{c(){e=b("div");for(let k=0;k<E.length;k+=1)E[k].c();t=O(),s=b("div");for(let k=0;k<i.length;k+=1)i[k].c();o=O(),a=b("div"),a.innerHTML=l,c=O(),h=b("div"),h.innerHTML=u,d=O(),f=b("div"),f.innerHTML=_,v=O(),g=b("div"),g.textContent=w,F=O(),R=b("p"),S=me("Puzzle for "),V=me(n[8]),this.h()},l(k){e=T(k,"DIV",{class:!0});var G=q(e);for(let le=0;le<E.length;le+=1)E[le].l(G);G.forEach(y),t=L(k),s=T(k,"DIV",{class:!0});var p=q(s);for(let le=0;le<i.length;le+=1)i[le].l(p);o=L(p),a=T(p,"DIV",{class:!0,"data-svelte-h":!0}),ee(a)!=="svelte-qtb4kv"&&(a.innerHTML=l),c=L(p),h=T(p,"DIV",{class:!0,"data-svelte-h":!0}),ee(h)!=="svelte-krp8l1"&&(h.innerHTML=u),d=L(p),f=T(p,"DIV",{class:!0,"data-svelte-h":!0}),ee(f)!=="svelte-1jsmx3m"&&(f.innerHTML=_),v=L(p),g=T(p,"DIV",{class:!0,"data-svelte-h":!0}),ee(g)!=="svelte-1qinv54"&&(g.textContent=w),p.forEach(y),F=L(k),R=T(k,"P",{class:!0});var j=q(R);S=ge(j,"Puzzle for "),V=ge(j,n[8]),j.forEach(y),this.h()},h(){P(e,"class","circle-container svelte-j8rz3o"),P(a,"class","key svelte-j8rz3o"),P(h,"class","key svelte-j8rz3o"),P(f,"class","key svelte-j8rz3o"),P(g,"class","key enter-key svelte-j8rz3o"),P(s,"class","keyboard svelte-j8rz3o"),P(R,"class","date svelte-j8rz3o")},m(k,G){D(k,e,G);for(let p=0;p<E.length;p+=1)E[p]&&E[p].m(e,null);D(k,t,G),D(k,s,G);for(let p=0;p<i.length;p+=1)i[p]&&i[p].m(s,null);I(s,o),I(s,a),I(s,c),I(s,h),I(s,d),I(s,f),I(s,v),I(s,g),D(k,F,G),D(k,R,G),I(R,S),I(R,V),B||(N=[he(a,"click",n[14]),he(h,"click",n[15]),he(f,"click",n[16]),he(g,"click",n[13])],B=!0)},p(k,G){if(G[0]&1040){C=$e(k[4]);let p;for(p=0;p<C.length;p+=1){const j=Hr(k,C,p);E[p]?E[p].p(j,G):(E[p]=Ur(j),E[p].c(),E[p].m(e,null))}for(;p<E.length;p+=1)E[p].d(1);E.length=C.length}G[0]&4640&&(x=$e(k[5]),i=Kr(i,G,Q,1,k,x,r,s,Nl,Wr,o,$r)),G[0]&256&&De(V,k[8])},d(k){k&&(y(e),y(t),y(s),y(F),y(R)),qr(E,k);for(let G=0;G<i.length;G+=1)i[G].d();B=!1,An(N)}}}function Ur(n){let e,t=(n[34]==""?"":n[34])+"",s,i,r;return{c(){e=b("div"),s=me(t),i=O(),this.h()},l(o){e=T(o,"DIV",{class:!0,style:!0});var a=q(e);s=ge(a,t),i=L(a),a.forEach(y),this.h()},h(){P(e,"class","circle svelte-j8rz3o"),P(e,"style",r=`
						left: calc(38% + ${Math.cos(n[36]/n[4].length*2*Math.PI-Math.PI/2)*100}px);
						top: calc(38% + ${Math.sin(n[36]/n[4].length*2*Math.PI-Math.PI/2)*100}px);
				`),Ft(e,"filled",n[34]!=""),Ft(e,"shared",n[10].includes(n[36]))},m(o,a){D(o,e,a),I(e,s),I(e,i)},p(o,a){a[0]&16&&t!==(t=(o[34]==""?"":o[34])+"")&&De(s,t),a[0]&16&&r!==(r=`
						left: calc(38% + ${Math.cos(o[36]/o[4].length*2*Math.PI-Math.PI/2)*100}px);
						top: calc(38% + ${Math.sin(o[36]/o[4].length*2*Math.PI-Math.PI/2)*100}px);
				`)&&P(e,"style",r),a[0]&16&&Ft(e,"filled",o[34]!="")},d(o){o&&y(e)}}}function Wr(n,e){let t,s=e[34]+"",i,r,o,a;function l(){return e[24](e[34],e[36])}return{key:n,first:null,c(){t=b("div"),i=me(s),r=O(),this.h()},l(c){t=T(c,"DIV",{class:!0});var h=q(t);i=ge(h,s),r=L(h),h.forEach(y),this.h()},h(){P(t,"class","key svelte-j8rz3o"),Ft(t,"disabled",e[9](e[36])),this.first=t},m(c,h){D(c,t,h),I(t,i),I(t,r),o||(a=he(t,"click",l),o=!0)},p(c,h){e=c,h[0]&32&&s!==(s=e[34]+"")&&De(i,s),h[0]&544&&Ft(t,"disabled",e[9](e[36]))},d(c){c&&y(t),o=!1,a()}}}function Vr(n){let e,t=zr(n[31])+"",s;return{c(){e=b("div"),s=me(t),this.h()},l(i){e=T(i,"DIV",{class:!0});var r=q(e);s=ge(r,t),r.forEach(y),this.h()},h(){P(e,"class","solution")},m(i,r){D(i,e,r),I(e,s)},p(i,r){r[0]&8&&t!==(t=zr(i[31])+"")&&De(s,t)},d(i){i&&y(e)}}}function ep(n){let e,t,s,i,r,o,a,l="Other Possible Solutions",c,h,u,d,f,_,v,g,w="Share",F,R,S,V,B=$e(n[3]),N=[];for(let C=0;C<B.length;C+=1)N[C]=Vr(Br(n,B,C));return{c(){e=b("span"),t=me("Solved in "),s=me(n[7]),i=O(),r=b("hr"),o=O(),a=b("span"),a.textContent=l,c=O();for(let C=0;C<N.length;C+=1)N[C].c();h=O(),u=b("br"),d=O(),f=b("div"),_=b("div"),v=O(),g=b("button"),g.textContent=w,F=O(),R=b("div"),this.h()},l(C){e=T(C,"SPAN",{class:!0});var E=q(e);t=ge(E,"Solved in "),s=ge(E,n[7]),E.forEach(y),i=L(C),r=T(C,"HR",{}),o=L(C),a=T(C,"SPAN",{class:!0,"data-svelte-h":!0}),ee(a)!=="svelte-zm2m22"&&(a.textContent=l),c=L(C);for(let Q=0;Q<N.length;Q+=1)N[Q].l(C);h=L(C),u=T(C,"BR",{}),d=L(C),f=T(C,"DIV",{class:!0});var x=q(f);_=T(x,"DIV",{class:!0}),q(_).forEach(y),v=L(x),g=T(x,"BUTTON",{class:!0,"data-svelte-h":!0}),ee(g)!=="svelte-1urjot1"&&(g.textContent=w),F=L(x),R=T(x,"DIV",{class:!0}),q(R).forEach(y),x.forEach(y),this.h()},h(){P(e,"class","sub-header svelte-j8rz3o"),P(a,"class","sub-header svelte-j8rz3o"),P(_,"class","spacer svelte-j8rz3o"),P(g,"class","share-button svelte-j8rz3o"),P(R,"class","spacer svelte-j8rz3o"),P(f,"class","flex-container svelte-j8rz3o")},m(C,E){D(C,e,E),I(e,t),I(e,s),D(C,i,E),D(C,r,E),D(C,o,E),D(C,a,E),D(C,c,E);for(let x=0;x<N.length;x+=1)N[x]&&N[x].m(C,E);D(C,h,E),D(C,u,E),D(C,d,E),D(C,f,E),I(f,_),I(f,v),I(f,g),I(f,F),I(f,R),S||(V=he(g,"click",n[17]),S=!0)},p(C,E){if(E[0]&128&&De(s,C[7]),E[0]&8){B=$e(C[3]);let x;for(x=0;x<B.length;x+=1){const Q=Br(C,B,x);N[x]?N[x].p(Q,E):(N[x]=Vr(Q),N[x].c(),N[x].m(h.parentNode,h))}for(;x<N.length;x+=1)N[x].d(1);N.length=B.length}},d(C){C&&(y(e),y(i),y(r),y(o),y(a),y(c),y(h),y(u),y(d),y(f)),qr(N,C),S=!1,V()}}}function tp(n){let e,t=`<span class="styled-header svelte-j8rz3o">Congratulations!</span> <br/>
		Share your results with your friends.`;return{c(){e=b("div"),e.innerHTML=t,this.h()},l(s){e=T(s,"DIV",{slot:!0,"data-svelte-h":!0}),ee(e)!=="svelte-jqfhji"&&(e.innerHTML=t),this.h()},h(){P(e,"slot","header")},m(s,i){D(s,e,i)},p:ye,d(s){s&&y(e)}}}function np(n){let e,t="Find the 8-letter circle word",s,i,r="<li>There are 2 words to find.</li> <li>Letters may only be used once and have to be in the letter bank.</li> <li>The red circles are shared letters between the two words.</li>",o,a,l="Example",c,h,u="If we had these letters:",d,f,_,v,g,w=`We could spell the words 
			<b><span style="color: red;">M</span>USI<span style="color: red;">C</span></b> 
			and 
			<b><span style="color: red;">C</span>HAR<span style="color: red;">M</span> </b>.`,F,R,S='Notice how these words share an <b><span style="color: red;">M</span></b> and a <b><span style="color: red;">C</span></b>.',V,B,N="One correct solution:",C,E,x,Q,k,G="Remember there can be more than one solution.";return{c(){e=b("h3"),e.textContent=t,s=O(),i=b("ul"),i.innerHTML=r,o=O(),a=b("h3"),a.textContent=l,c=O(),h=b("p"),h.textContent=u,d=O(),f=b("img"),v=O(),g=b("p"),g.innerHTML=w,F=O(),R=b("p"),R.innerHTML=S,V=O(),B=b("p"),B.textContent=N,C=O(),E=b("img"),Q=O(),k=b("p"),k.textContent=G,this.h()},l(p){e=T(p,"H3",{"data-svelte-h":!0}),ee(e)!=="svelte-1j8js8f"&&(e.textContent=t),s=L(p),i=T(p,"UL",{class:!0,"data-svelte-h":!0}),ee(i)!=="svelte-wtdfry"&&(i.innerHTML=r),o=L(p),a=T(p,"H3",{"data-svelte-h":!0}),ee(a)!=="svelte-qg4234"&&(a.textContent=l),c=L(p),h=T(p,"P",{"data-svelte-h":!0}),ee(h)!=="svelte-eqhtsw"&&(h.textContent=u),d=L(p),f=T(p,"IMG",{src:!0,alt:!0,style:!0}),v=L(p),g=T(p,"P",{"data-svelte-h":!0}),ee(g)!=="svelte-14urd7p"&&(g.innerHTML=w),F=L(p),R=T(p,"P",{"data-svelte-h":!0}),ee(R)!=="svelte-1xer9do"&&(R.innerHTML=S),V=L(p),B=T(p,"P",{"data-svelte-h":!0}),ee(B)!=="svelte-1tryhud"&&(B.textContent=N),C=L(p),E=T(p,"IMG",{src:!0,alt:!0,style:!0}),Q=L(p),k=T(p,"P",{"data-svelte-h":!0}),ee(k)!=="svelte-1imbt6f"&&(k.textContent=G),this.h()},h(){P(i,"class","definition-list"),Ri(f.src,_=Hl)||P(f,"src",_),P(f,"alt","Welcome"),Lt(f,"width","350px"),Lt(f,"height","auto"),Ri(E.src,x=$l)||P(E,"src",x),P(E,"alt","Welcome"),Lt(E,"width","150px"),Lt(E,"height","auto")},m(p,j){D(p,e,j),D(p,s,j),D(p,i,j),D(p,o,j),D(p,a,j),D(p,c,j),D(p,h,j),D(p,d,j),D(p,f,j),D(p,v,j),D(p,g,j),D(p,F,j),D(p,R,j),D(p,V,j),D(p,B,j),D(p,C,j),D(p,E,j),D(p,Q,j),D(p,k,j)},p:ye,d(p){p&&(y(e),y(s),y(i),y(o),y(a),y(c),y(h),y(d),y(f),y(v),y(g),y(F),y(R),y(V),y(B),y(C),y(E),y(Q),y(k))}}}function sp(n){let e,t='<span class="styled-header svelte-j8rz3o">How To Play</span>';return{c(){e=b("h2"),e.innerHTML=t,this.h()},l(s){e=T(s,"H2",{slot:!0,"data-svelte-h":!0}),ee(e)!=="svelte-agigkf"&&(e.innerHTML=t),this.h()},h(){P(e,"slot","header")},m(s,i){D(s,e,i)},p:ye,d(s){s&&y(e)}}}function ip(n){let e,t,s,i,r="Resume",o,a,l,c;return{c(){e=b("div"),t=b("div"),s=O(),i=b("button"),i.textContent=r,o=O(),a=b("div"),this.h()},l(h){e=T(h,"DIV",{class:!0});var u=q(e);t=T(u,"DIV",{class:!0}),q(t).forEach(y),s=L(u),i=T(u,"BUTTON",{class:!0,"data-svelte-h":!0}),ee(i)!=="svelte-o41kx2"&&(i.textContent=r),o=L(u),a=T(u,"DIV",{class:!0}),q(a).forEach(y),u.forEach(y),this.h()},h(){P(t,"class","spacer svelte-j8rz3o"),P(i,"class","share-button svelte-j8rz3o"),P(a,"class","spacer svelte-j8rz3o"),P(e,"class","flex-container svelte-j8rz3o")},m(h,u){D(h,e,u),I(e,t),I(e,s),I(e,i),I(e,o),I(e,a),l||(c=he(i,"click",n[19]),l=!0)},p:ye,d(h){h&&y(e),l=!1,c()}}}function rp(n){let e,t='<span class="styled-header svelte-j8rz3o">Paused</span>';return{c(){e=b("h2"),e.innerHTML=t,this.h()},l(s){e=T(s,"H2",{slot:!0,"data-svelte-h":!0}),ee(e)!=="svelte-he3kx2"&&(e.innerHTML=t),this.h()},h(){P(e,"slot","header")},m(s,i){D(s,e,i)},p:ye,d(s){s&&y(e)}}}function op(n){let e,t,s,i='<p class="title svelte-j8rz3o">LetterLoop</p> <small style="color: rgb(46, 46, 46);">(public beta) · Edited by Henry Macht</small>',r,o,a,l,c='<i class="fa-regular fa-circle-question"></i> <p class="how-to-play svelte-j8rz3o">How to play</p>',h,u,d,f,_,v,g,w,F,R,S,V='<i class="fa-solid fa-pause"></i>',B,N,C,E,x,Q,k,G,p,j,le,W,ce;f=new Qr({});function Ge(A){n[23](A)}let rn={};n[7]!==void 0&&(rn.elapsedSeconds=n[7]),w=new X_({props:rn}),n[22](w),gt.push(()=>an(w,"elapsedSeconds",Ge));function ct(A,z){return A[3].length>0?Z_:J_}let ht=ct(n),Ce=ht(n);function ol(A){n[25](A)}let vi={$$slots:{header:[tp],default:[ep]},$$scope:{ctx:n}};n[0]!==void 0&&(vi.showModal=n[0]),C=new Kn({props:vi}),gt.push(()=>an(C,"showModal",ol));function al(A){n[26](A)}let Ci={$$slots:{header:[sp],default:[np]},$$scope:{ctx:n}};n[1]!==void 0&&(Ci.showModal=n[1]),Q=new Kn({props:Ci}),gt.push(()=>an(Q,"showModal",al));function ll(A){n[27](A)}let wi={hide_close:!0,$$slots:{header:[rp],default:[ip]},$$scope:{ctx:n}};return n[2]!==void 0&&(wi.showModal=n[2]),p=new Kn({props:wi}),gt.push(()=>an(p,"showModal",ll)),{c(){e=b("main"),t=b("div"),s=b("div"),s.innerHTML=i,r=O(),o=b("div"),a=O(),l=b("div"),l.innerHTML=c,h=O(),u=b("div"),d=O(),ft(f.$$.fragment),_=O(),v=b("div"),g=b("div"),ft(w.$$.fragment),R=O(),S=b("div"),S.innerHTML=V,B=O(),Ce.c(),N=O(),ft(C.$$.fragment),x=O(),ft(Q.$$.fragment),G=O(),ft(p.$$.fragment),this.h()},l(A){e=T(A,"MAIN",{class:!0});var z=q(e);t=T(z,"DIV",{class:!0});var Re=q(t);s=T(Re,"DIV",{class:!0,"data-svelte-h":!0}),ee(s)!=="svelte-12b2d73"&&(s.innerHTML=i),r=L(Re),o=T(Re,"DIV",{class:!0}),q(o).forEach(y),a=L(Re),l=T(Re,"DIV",{class:!0,"data-svelte-h":!0}),ee(l)!=="svelte-zy39qn"&&(l.innerHTML=c),Re.forEach(y),h=L(z),u=T(z,"DIV",{class:!0}),q(u).forEach(y),d=L(z),_t(f.$$.fragment,z),_=L(z),v=T(z,"DIV",{class:!0});var Be=q(v);g=T(Be,"DIV",{class:!0});var ut=q(g);_t(w.$$.fragment,ut),ut.forEach(y),R=L(Be),S=T(Be,"DIV",{"data-svelte-h":!0}),ee(S)!=="svelte-sbbujr"&&(S.innerHTML=V),Be.forEach(y),B=L(z),Ce.l(z),z.forEach(y),N=L(A),_t(C.$$.fragment,A),x=L(A),_t(Q.$$.fragment,A),G=L(A),_t(p.$$.fragment,A),this.h()},h(){P(s,"class","title-container  svelte-j8rz3o"),P(o,"class","spacer svelte-j8rz3o"),P(l,"class","help-container svelte-j8rz3o"),P(t,"class","nav-flex-container svelte-j8rz3o"),P(u,"class","divider svelte-j8rz3o"),P(g,"class","timer-container svelte-j8rz3o"),P(v,"class","flex-container svelte-j8rz3o"),P(e,"class","svelte-j8rz3o")},m(A,z){D(A,e,z),I(e,t),I(t,s),I(t,r),I(t,o),I(t,a),I(t,l),I(e,h),I(e,u),I(e,d),pt(f,e,null),I(e,_),I(e,v),I(v,g),pt(w,g,null),I(v,R),I(v,S),I(e,B),Ce.m(e,null),D(A,N,z),pt(C,A,z),D(A,x,z),pt(Q,A,z),D(A,G,z),pt(p,A,z),le=!0,W||(ce=[he(window,"keydown",El(n[11])),he(l,"click",n[21]),he(S,"click",n[18])],W=!0)},p(A,z){const Re={};!F&&z[0]&128&&(F=!0,Re.elapsedSeconds=A[7],on(()=>F=!1)),w.$set(Re),ht===(ht=ct(A))&&Ce?Ce.p(A,z):(Ce.d(1),Ce=ht(A),Ce&&(Ce.c(),Ce.m(e,null)));const Be={};z[0]&136|z[1]&128&&(Be.$$scope={dirty:z,ctx:A}),!E&&z[0]&1&&(E=!0,Be.showModal=A[0],on(()=>E=!1)),C.$set(Be);const ut={};z[1]&128&&(ut.$$scope={dirty:z,ctx:A}),!k&&z[0]&2&&(k=!0,ut.showModal=A[1],on(()=>k=!1)),Q.$set(ut);const Gn={};z[1]&128&&(Gn.$$scope={dirty:z,ctx:A}),!j&&z[0]&4&&(j=!0,Gn.showModal=A[2],on(()=>j=!1)),p.$set(Gn)},i(A){le||(Te(f.$$.fragment,A),Te(w.$$.fragment,A),Te(C.$$.fragment,A),Te(Q.$$.fragment,A),Te(p.$$.fragment,A),le=!0)},o(A){Se(f.$$.fragment,A),Se(w.$$.fragment,A),Se(C.$$.fragment,A),Se(Q.$$.fragment,A),Se(p.$$.fragment,A),le=!1},d(A){A&&(y(e),y(N),y(x),y(G)),mt(f),n[22](null),mt(w),Ce.d(),mt(C,A),mt(Q,A),mt(p,A),W=!1,An(ce)}}}function jr(n){return n.split("").sort(()=>Math.random()-.5).join("")}function zr(n){const e=n.substring(0,5),t=n.substring(4,8)+e[0];return`${e} + ${t}`}function ap(n,e,t){let s,i,r=!1,o=!1,a=!1,l=[];l=l.map(W=>W.toLowerCase());let c,h=Array(8).fill(""),u=[],d,f=0,_=[0,4],v,g=0;fl(async()=>{const W=q_(Eh);rl(W,"screen_view",{firebase_screen:"game_board_view",firebase_screen_class:"game_board_controller"});const ce=new Date,Ge={year:"numeric",month:"2-digit",day:"2-digit"},rn=ce.toLocaleDateString("en-US",Ge).replace(/\//g,"-");try{const ct=await kf("solutions/"+rn),ht=Object.values(ct);t(3,l=ht),c=l[0],t(5,d=jr(c)),v.start()}catch(ct){console.error("Error fetching data from Firebase:",ct)}});function w(W){const ce=W.key.toLowerCase(),Ge=d.indexOf(ce);W.keyCode===13?R():W.keyCode===8?B():Ge!==-1&&!s(Ge)&&F(ce,Ge)}function F(W,ce){f<h.length&&!s(ce)&&(t(4,h[f]=W,h),f+=1,t(20,u=[...u,ce]))}function R(){const W=h.join("");l.includes(W)?(t(0,r=!0),v.stop(),Af(g)):un.default("Incorrect",1e3)}function S(){t(4,h=Array(8).fill("")),f=0,t(20,u=[])}function V(){t(5,d=jr(c)),S()}function B(){f>0&&(t(4,h[f-1]="",h),f-=1,t(20,u=u.slice(0,-1)))}function N(){let W=`I completed the LetterLoop in: 
🔴`+g+"🔴";navigator.clipboard.writeText(W).then(()=>{console.log("Text successfully copied to clipboard:",W),un.default("Copied Text!",1e3)}).catch(ce=>{console.error("Error copying text to clipboard:",ce),un.default("Error",1e3)})}function C(){v.stop(),t(2,a=!0)}function E(){v.start(),t(2,a=!1)}const x=()=>t(1,o=!0);function Q(W){gt[W?"unshift":"push"](()=>{v=W,t(6,v)})}function k(W){g=W,t(7,g)}const G=(W,ce)=>F(W,ce);function p(W){r=W,t(0,r)}function j(W){o=W,t(1,o)}function le(W){a=W,t(2,a)}return n.$$.update=()=>{n.$$.dirty[0]&1048576&&t(9,s=W=>u.includes(W))},t(8,i=new Date().toLocaleDateString(void 0,{year:"numeric",month:"long",day:"numeric"})),[r,o,a,l,h,d,v,g,i,s,_,w,F,R,S,V,B,N,C,E,u,x,Q,k,G,p,j,le]}class dp extends Pn{constructor(e){super(),Mn(this,e,ap,op,Dn,{},null,[-1,-1])}}export{dp as component,up as universal};
